...
wr.insertUser(db, "Unemployed_Todd", "Todd123!", "Todd", "Helsinki", 1)
wr.insertUser(db, "James_88", "James123!", "James", "Bryant", 1)
wr.insertUser(db, 'Billy_The_Goat','Billy123!','Billy', 'Baaa', 1)
wr.insertUser(db, 'All_Mighty_Jesus','Jesus123!', 'Jesus', 'Ramirez', 1)
wr.insertUser(db, 'Trent.exe','Trent123!','Trent', 'Howard', 1)
wr.insertUser(db, 'Undertaker','Sckyler123!','lamb', 'password', 1)
wr.insertUser(db, 'Parxi','Ready123!','Xhristophin', 'one', 1)
wr.insertUser(db, 'darthmartain','Starwars123!','Nickoly', 'micky', 1)
wr.insertUser(db, 'KnightNinja','Knsd123!','Knight', 'Ninja', 1)
